...
$subheading = sprintf(
	'<h3>%1s %2s %3s.</h3>',
	esc_html__( 'This is your custom', 'ch-directs-plugin' ),
	get_bloginfo( 'name' ),
...
<div class="welcome-panel-content custom">
	...
	<?php echo sprintf(
		'<h2>%1s %2s.</h2>',
		esc_html__( 'Welcome,', 'ch-directs-plugin' ),
		$user_name
	); ?>
	...
	<div class="welcome-panel-column-container">
		...
		<div class="welcome-panel-column">
			<?php do_action( 'chp_welcome_panel_column_first_before' ); ?>
				...
				<?php if ( is_active_sidebar( 'chp_welcome_widget_first' ) ) {
					...
					$placeholder = sprintf(
						'<h3>%1s</h3>',
						esc_html( 'Column One', 'ch-directs-plugin' )
					);
					$placeholder .= sprintf(
						'<p><a href="%1s">%2s</a> %3s.</p>',
						admin_url( 'widgets.php' ),
						__( 'Add a widget', 'ch-directs-plugin' ),
						__( 'to this area', 'ch-directs-plugin' )
					);
		...
		<div class="welcome-panel-column">
			...
			<?php if ( is_active_sidebar( 'chp_welcome_widget_second' ) ) {
					...
					$placeholder = sprintf(
						'<h3>%1s</h3>',
						esc_html( 'Column Two', 'ch-directs-plugin' )
					);
					$placeholder .= sprintf(
						'<p><a href="%1s">%2s</a> %3s.</p>',
						admin_url( 'widgets.php' ),
		...
		<div class="welcome-panel-column welcome-panel-last">
			...
			<?php if ( is_active_sidebar( 'chp_welcome_widget_last' ) ) {
					...
					$placeholder = sprintf(
						'<h3>%1s</h3>',
						esc_html( 'Column Three', 'ch-directs-plugin' )
					);
					$placeholder .= sprintf(
						'<p><a href="%1s">%2s</a> %3s.</p>',
						admin_url( 'widgets.php' ),
