...
$tabs = [
    ...
    sprintf(
        ...
        '#intro',
        esc_html__( 'Introduction', 'ch-directs-plugin' )
	),
    ...
    sprintf(
		...
		'#settings',
		esc_attr( $settings ),
        esc_html__( 'Site Settings', 'ch-directs-plugin' )
	),
    ...
    sprintf(
        ...
        '#scripts',
        esc_html__( 'Script Options', 'ch-directs-plugin' )
	),
    ...
    sprintf(
        ...
        '#media',
        esc_html__( 'Media Options', 'ch-directs-plugin' )
	),
    ...
    sprintf(
        '<li><a href="%1s"><span class="dashicons dashicons-welcome-learn-more"></span> %2s</a></li>',
        '#tools',
        esc_html__( 'Development Tools', 'ch-directs-plugin' )
    ),
...
<div class="wrap site-plugin-wrap">
	<!-- Page heading -->
	<?php echo sprintf( '<h1 class="wp-heading-inline">%1s %2s</h1>', get_bloginfo( 'name' ), esc_html__( 'Plugin', 'ch-directs-plugin' ) ); ?>
	<!-- Page description -->
    <p class="description"><?php esc_html_e( 'A feature-packed WordPress starter plugin for building custom-tailored websites.', 'ch-directs-plugin' ); ?></p>
	...
	<div class="backend-tabbed-content">
		...
		<div id="intro"><!-- Introduction content -->
			<?php include_once CHD_PATH . 'admin/partials/plugin-page-intro.php'; ?>
		</div>
		<div id="settings"><!-- Site Settings content -->
			<?php include_once CHD_PATH . 'admin/partials/plugin-page-site-settings.php'; ?>
		</div>
		<div id="scripts"><!-- Script Options content -->
			<?php include_once CHD_PATH . 'admin/partials//plugin-page-script-options.php'; ?>
		</div>
		<div id="media"><!-- Media Options content -->
			<?php include_once CHD_PATH . 'admin/partials/plugin-page-media-options.php'; ?>
		</div>
		<div id="tools"><!-- Dev Tools content -->
			<?php include_once CHD_PATH . 'admin/partials/plugin-page-dev-tools.php'; ?>
		</div>
		<?php // Hook for adding tabbed content.
