...
<div class="wrap site-plugin-wrap">
	...
	<div class="backend-tabbed-content">
		...
		<div id="settings"><!-- Site Settings content -->
			<?php include_once CHP_PATH . 'admin/partials/plugin-page-site-settings.php'; ?>
		</div>
		<div id="scripts"><!-- Script Options content -->
			<?php include_once CHP_PATH . 'admin/partials//plugin-page-script-options.php'; ?>
		</div>
		<div id="media"><!-- Media Options content -->
			<?php include_once CHP_PATH . 'admin/partials/plugin-page-media-options.php'; ?>
		</div>
