...
namespace CH_Plugin\Admin\Partials\Help;
...
<?php echo sprintf( '<li><strong>%1s:</strong> %2s</li>', esc_html__( 'Filters', 'ch-directs-plugin' ), esc_html__( 'Filters are prexixed with an abbreviation for the plugin name. Replace "chp".', 'ch-directs-plugin' ) ); ?>
<?php echo sprintf( '<li><strong>%1s:</strong> %2s</li>', esc_html__( 'Pages', 'ch-directs-plugin' ), esc_html__( 'Admin page URLs are prexixed with an abbreviation for the plugin name. The above replace of "chp" will have given them your new prefix.', 'ch-directs-plugin' ) ); ?>
<?php echo sprintf( '<li><strong>%1s:</strong> %2s</li>', esc_html__( 'Options', 'ch-directs-plugin' ), esc_html__( 'Options are prexixed with an abbreviation for the plugin name. The above replace of "chp" will have given them your new prefix.', 'ch-directs-plugin' ) ); ?>
