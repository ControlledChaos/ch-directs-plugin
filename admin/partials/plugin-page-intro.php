...
<ul class="chd_bullet-list">
	...
	<li><?php _e( 'Run a modern setup and you\'ll be fine.', 'ch-directs-plugin' ); ?></li>
</ul>
<?php echo sprintf(
	'<p>%1s</p>',
	__( 'Sample editor blocks are included in preparation for WordPress 5.0 with it\'s new user interface. Until that release, the <a href="%2s" target="_blank">Gutenberg</a> plugin is required to use the blocks.', 'ch-directs-plugin' ),
...
<?php echo sprintf(
	...
	__( 'For a nicer user experience, this plugin is recommended for use with', 'ch-directs-plugin' ),
	esc_url( 'https://www.advancedcustomfields.com/pro/' ),
	'Advanced Custom Fields PRO',
	__( 'or the', 'ch-directs-plugin' ),
	esc_url( 'https://wordpress.org/plugins/advanced-custom-fields/' ),
	__( 'free version of ACF', 'ch-directs-plugin' ),
	__( 'plus the', 'ch-directs-plugin' ),
	esc_url( 'https://www.advancedcustomfields.com/add-ons/options-page/' ),
	__( 'Options Page', 'ch-directs-plugin' ),
	__( 'addon. However, most of the ACF features are duplicated using the', 'ch-directs-plugin' ),
	esc_url( 'https://developer.wordpress.org/plugins/settings/settings-api/' ),
	__( 'WordPress settings API', 'ch-directs-plugin' ),
	__( 'to reduce third-party dependencies.', 'ch-directs-plugin' )
 ); ?>

<!-- Section heading -->
<h3><?php _e( 'Additional Information', 'ch-directs-plugin' ); ?></h3>
