...
$tabs = [
    ...
    sprintf(
        ...
        esc_html__( 'Vendor', 'ch-directs-plugin' )
    )
 ...
 */
if ( 'general' == $active_tab  ) {
    $save = __( 'Save General', 'ch-directs-plugin' );
} elseif ( 'vendor' == $active_tab ) {
    $save = __( 'Save Vendor', 'ch-directs-plugin' );
} else {
...
?>
<div class="wrap">
    <h1 class="wp-heading-inline"><?php esc_html_e( 'Script Options', 'ch-directs-plugin' ); ?></h1>
    <?php if ( is_rtl() ) : ?>
    <p class="description"><?php esc_html_e( 'Script settings from the Controlled Chaos plugin. More information in the Help tab at upper left.', 'ch-directs-plugin' ); ?></p>
    <?php else : ?>
    <p class="description"><?php esc_html_e( 'Script settings from the Controlled Chaos plugin. More information in the Help tab at upper right.', 'ch-directs-plugin' ); ?></p>
    <?php endif; ?>
