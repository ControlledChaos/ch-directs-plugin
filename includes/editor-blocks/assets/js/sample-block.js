...
( function() {
	...
	*/
	registerBlockType( 'chp/sample-block', {
		...
		edit: function(props) {
			// Creates a <p class='wp-block-chp-sample-block"'></p>.
			return el(
				'p', // Tag type.
				{ className: props.className }, // The class="wp-block-chp-sample-block" : The class name is generated using the block's name prefixed with wp-block-, replacing the / namespace separator with a single -.
